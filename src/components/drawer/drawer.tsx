...
class Drawer extends Component<DrawerProps> {
    ...
    private _handleStopPropagation = (event: MouseEvent<HTMLDivElement>): void => {
    ...
    render():
        ...
        | null
        | undefined {
        const { visible, title, mask, maskClosable, closable, children, placement, width, height } = this.props
        return (
            visible && (
                <Portal container={this.container}>
                    <div className='drawer'>
                        {mask && <div className='drawer-mask' onClick={maskClosable ? this._handleClose : null} />}
                        <div
                            ...
                            style={{
                                width: placement === 'left' || placement === 'right' ? width : 'unset',
                                height: placement === 'top' || placement === 'bottom' ? height : 'unset',
                            }}
                            onClick={this._handleStopPropagation}>
                            {title && (
                                <Flex className='drawer-header' justifyContent='spaceBetween' alignItems='center'>
                                    {title}
                                    {closable && <CloseOutlined className='drawer-header-close' onClick={this._handleClose} />}
                                </Flex>
                            )}
