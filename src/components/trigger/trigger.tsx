import React, { cloneElement, ReactElement, MutableRefObject, MouseEvent, Component, createRef } from 'react'
...
class Trigger<T extends { duration?: number }> extends Component<TriggerProps<T>> {
