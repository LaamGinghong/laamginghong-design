...
class Modal extends Component<ModalProps, ModalState> {
    ...
    render():
        ...
        | null
        | undefined {
        const { visible, title, okButton, footer, closable, cancelButton, mask, maskClosable, children } = this.props
        const { loading } = this.state
            ...
            visible && (
                <Portal container={this.container}>
                    <div className='modal-wrap'>
                        {mask && <div className='modal-mask' onClick={maskClosable ? this._handleCancel : undefined} />}
                        <div className='modal' style={{ width }}>
                            <div className='modal-content'>
                                {closable && <CloseOutlined className='modal-close' onClick={this._handleCancel} />}
